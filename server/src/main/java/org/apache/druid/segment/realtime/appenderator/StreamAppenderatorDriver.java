...
public class StreamAppenderatorDriver extends BaseAppenderatorDriver
{
  ...
  )
  {
    ...
    final ListenableFuture<SegmentsAndMetadata> publishFuture = Futures.transform(
        ...
        (AsyncFunction<SegmentsAndMetadata, SegmentsAndMetadata>) sam -> publishInBackground(
            null,
            sam,
            publisher
        )
  ...
  )
  {
    return Futures.transform(
        ...
        (AsyncFunction<SegmentsAndMetadata, SegmentsAndMetadata>) this::registerHandoff
    );
  }
